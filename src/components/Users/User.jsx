...
export const User = ({ id, email, first_name, last_name, avatar, onClickInvite1, invites1 }) => (
  <li>
    <div>
    ...
    <img
      onClick={() => onClickInvite1(id)}
      className="action"
      src={`/react-users/assets/${invites1.includes(id) ? 'minus' : 'plus'}.svg`}
      alt="Action"
    />
  </li>
);
